...
nohup /aquila-node/target/release/node-template \
  --telemetry-url 'wss://telemetry.polkadot.io/submit/ 0' \
	--base-path /tmp/node_airtel_val2_02 \
  ...
  --rpc-cors all \
	...
	--public-addr /ip4/52.95.249.101/tcp/30333 \
	--bootnodes /ip4/13.126.124.205/tcp/30333/p2p/12D3KooWDeyKmW2ri7qsR19eL6FdgHeJ517U8KLrQHqepy229KhR \
  --no-mdns \
  --ws-external \
  --rpc-external \
	--rpc-methods=Unsafe \
	--name node_validator_2 &
